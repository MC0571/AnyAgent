...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like AnyAgent to show its work?",
  ...
  "startup.global.silent": "Starting AnyAgent",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen AnyAgent.",
  ...
  "startup.global.starting_services": "Starting AnyAgent",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "AnyAgent will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another AnyAgent or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen AnyAgent. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen AnyAgent to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen AnyAgent.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a AnyAgent restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into AnyAgent",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to AnyAgent and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to AnyAgent",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to AnyAgent",
  "login.description": "Connect your account to start using AnyAgent",
  ...
  "logout.confirm.title": "Disconnect and restart AnyAgent?",
  ...
  "titleBar.menu.help.about": "About AnyAgent",
  ...
  "forceUpdate.title": "Update AnyAgent to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart AnyAgent to continue.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "AnyAgent checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the AnyAgent terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While AnyAgent is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the AnyAgent installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching AnyAgent task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by AnyAgent",
  ...
  "resourceManager.storage.diskUsage": "AnyAgent uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the AnyAgent desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "AnyAgent could not verify its Windows secure import component. Reinstall or update AnyAgent before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, AnyAgent will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.host.activeDescription":
    "AnyAgent provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This ZCode Agent cannot refresh OAuth status. Upgrade or restart AnyAgent, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to AnyAgent to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into AnyAgent",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by AnyAgent automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in AnyAgent.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. AnyAgent uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in AnyAgent after purchase or setup.",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into AnyAgent. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. AnyAgent follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into AnyAgent",
  ...
  "settings.plugins.store.subtitle":
    "Extend AnyAgent with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into AnyAgent and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. AnyAgent follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into AnyAgent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into AnyAgent. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. AnyAgent follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into AnyAgent",
  ...
  "settingsSync.action.finish": "Start using AnyAgent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current AnyAgent settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to AnyAgent",
  ...
  "onboarding.welcome.title": "Welcome to AnyAgent",
  "onboarding.welcome.start": "Start AnyAgent",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while AnyAgent imports your selections.",
  ...
  "chat.placeholder.newTask":
    "Ask AnyAgent anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask AnyAgent anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, AnyAgent will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want AnyAgent to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart AnyAgent app and retry, or ask AnyAgent to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with AnyAgent in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for AnyAgent: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with AnyAgent in chat and save a new version.",
  ...
  "resourceManager.appUsage": "AnyAgent",
  ...
  "feedback.submit.template.section.copyErrorHeading": "AnyAgent Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while AnyAgent is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task AnyAgent can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "AnyAgent Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "AnyAgent Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart AnyAgent",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart AnyAgent to fully reload the Helper process.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "AnyAgent will verify the Computer Use tools against the exact session when your first session starts.",
