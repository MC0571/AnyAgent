...
const WORKFLOW_NAME = "Open in AnyAgent.workflow";
const WORKFLOW_BUNDLE_ID = "dev.anyagent.app.finder-open-workflow";
const WORKFLOW_VERSION = "1";
const SERVICES_MENU_LABELS: Record<Locale, string> = {
  "zh-CN": "在AnyAgent中打开",
  "en-US": "Open in AnyAgent",
};
...
if [ -n "$first" ]; then
  ...
  /usr/bin/open "anyagent://workspace/open?path=\${encoded}"
fi
`;
