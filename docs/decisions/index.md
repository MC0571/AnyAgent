...
| [0004：任务业务收尾与实际执行状态分离](0004-task-closure-is-distinct-from-execution-state.md) | Architecture | Accepted | 2026-09-22 | 允许用户显式放弃后续协调并对任务管理收尾或归档，同时保留未知执行、残留风险、资源占用限制和后续对账责任。 |
